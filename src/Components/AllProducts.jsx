...
const AllProducts = () => {
  ...
  return (
    ...
    <div className='mx-8 grid grid-cols-1 gap-8 mt-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
    <div className="flex flex-col items-center justify-center w-full max-w-lg mx-auto">
            <img onClick={()=>Navigate("/single-product")} className="object-cover cursor-pointer w-full rounded-md h-72 xl:h-80" src="https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=634&q=80" alt="T-Shirt" />
            <h4 className="mt-2 text-lg font-medium text-gray-700">Printed T-shirt</h4>
