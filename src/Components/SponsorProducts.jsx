...
const SponsorProducts = () => {
  return (
    ...
    <div className=" flex flex-wrap overflow-y-scroll h-[488px] mx-auto">
  <div className="bg-white drop-shadow-md w-1/2 mt-4 rounded-lg max-w-sm dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
      <img className="rounded-t-lg p-8" src="https://dummyimage.com/200x200" alt="product image" />
    </a>
    <div className="px-5 pb-5">
      <a href="#">
        <h3 className="text-gray-900 font-semibold text-sm tracking-tight dark:text-white">Apple Watch Series 7
