      ...
      <div>
                          ...
                          <>
                            <h3 className="-mx-2 -my-3 flow-root">
                              <Disclosure.Button className="px-2 py-3 bg-white w-full flex items-center justify-between text-gray-400 hover:text-gray-500">
                                <span className="font-medium text-skin-primary">{section.name}</span>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="z-10 flex items-baseline justify-between pt-24 pb-6 border-b border-gray-200">
            <h1 className="text-4xl font-extrabold tracking-tight text-skin-primary">Our Shop</h1>
            ...
            <div className="flex items-center">
              <Menu as="div" className="inline-block text-left">
                ...
                >
                  <Menu.Items className="origin-top-right absolute right-50 mt-2 w-40 rounded-md shadow-2xl bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
